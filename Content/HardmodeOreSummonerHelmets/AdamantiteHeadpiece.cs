...
public class AdamantiteHeadpiece : ModItem
{
	...
	private const float SummonDamageIncrease = 0.08f;
	...
	public override bool IsArmorSet(Item head, Item body, Item legs) {
		return head.ModItem is AdamantiteHeadpiece && body.type == ItemID.AdamantiteBreastplate && legs.type == ItemID.AdamantiteLeggings;
	}
